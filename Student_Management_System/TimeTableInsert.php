    ...
    <div class="studentform container flex-d mt-5 mb-5" style="width:40%; border: 1px solid #e6f7ff; padding: 60px; background-image: linear-gradient(180deg, #cce6ff, #e6f2ff); border-radius: 25px;">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            <div class="formname">
                ...
                <div class="fileuploder btn" >
                    <input type="file" name="uploadfile" id="">
                </div>
                <div class="inputtxtbox d-flex text-dark mt-1">
                    <label class="form-label " for="">File ID </label>
                    <input class="form-control mx-4" style="width:30%" type="text" name="fileid" id="">
                </div>

            <div class="allcontrolbtn d-flex mt-5 mb-5">
                <div class="controlbtn">
                    <input class="btn btn-primary px-4" type="submit" value="INSERT" name="insert">
                </div>
                <div class="controlbtn">
                    <input class="btn btn-danger px-4 mx-5" type="submit" value="DELETE" name="delete">
                </div>
                <div class="controlbtn">
                    <input class="btn btn-info px-4 mx-2" type="submit" value="SEARCH" name="search">
                </div>
            </div>
        </form>
        </form>
